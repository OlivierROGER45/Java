  ...
  return arg !== value;
    ...
    var validator =  $contactform.validate({
      ...
      messages: {
        ...
        poids: {
          required: "S'il vous plait remplir votre Poids avec des nombre à virgule.",
          minlength: "Vous devez avoir au moins 2 caractere pour votre Nom."
        },
        taille: {
          required: "S'il vous plait remplir votre Taille avec des nombre à virgule.",
          minlength: "Vous devez avoir au moins 2 caractere pour votre Nom."
        },
        email: {
        ...
        dteNaiss: {
          ...
          minlength: "S'il vous plait remplir une Date de naissance valide."
        },
        street: {
